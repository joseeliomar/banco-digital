...
public class EnderecoAlteradoDto implements Serializable {
	...
	public EnderecoAlteradoDto() {
	}

	public EnderecoAlteradoDto(Endereco endereco) {
		id = endereco.getId();
		rua = endereco.getRua();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EnderecoAlteradoDto other = (EnderecoAlteradoDto) obj;
